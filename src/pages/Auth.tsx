...
export default function Auth() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20 flex items-center justify-center p-4">
          ...
          <CardContent>
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="signup-password" type="password" placeholder="Escolha uma senha" value={password} onChange={e => setPassword(e.target.value)} required minLength={6} />
                  </div>
                  <Button type="submit" className="w-full" disabled={loading}>
            ...
            <div className="mt-6 text-center">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Sistema corporativo para CFOs</span>
              </div>
            </div>
          </CardContent>
        </Card>
